...
namespace UniversityApiBackend.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<User>>> GetAdminUsers()
        {
            ...
            stopwatch.Start();
            var adminUsers = await _context.Users.Where(user => user.Role.Equals("Administrator")).ToListAsync();
            stopwatch.Stop();
            Console.WriteLine($"Admin users search duration: {stopwatch.Elapsed}");
